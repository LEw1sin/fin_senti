...
all_senti_similarity ={**meso_senti_data, **data_2020_senti_similarity}

with open('../processed_data/all_senti_similarity.json', 'w', encoding='utf-8') as file:
    json.dump(all_senti_similarity, file, ensure_ascii=False, indent=4)
