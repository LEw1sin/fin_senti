...
class MLP(torch.nn.Module):
    def __init__(self, config, args,output_n=5, layer_list=[768*3, 768,64], dropout=0.5, rnn_dim=128):
        """
...
with open('/project/Finbert/Fink_NER_ED_Web/bert-base-chinese/vocab.txt', "r") as f:
    lines = f.readlines()
    d = {}
