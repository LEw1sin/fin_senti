...
model = AutoModel.from_pretrained('BAAI/bge-large-zh-v1.5').to(device='cuda:0')
model.eval()
...
meso_news_filepath = "../raw_data/merged_data_except_2020.json"
...
np.save("../raw_data/merged_data_except_2020_embedding.npy", np.array(meso_news_embeddings))
